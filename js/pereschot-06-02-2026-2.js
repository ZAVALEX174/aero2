...
console.log("07/02/2026 10-30 - Версия с неразрывными соединениями линий - ИСПРАВЛЕННАЯ");
...
function splitLineAtPoint(line, point) {
	...
	// Распределяем объем воздуха пропорционально сопротивлениям
	const totalResistance = airResistance1 + airResistance2;
	const airVolume1 = totalResistance > 0 ? roundTo5((props.airVolume || 0) * (airResistance2 / totalResistance)) : 0;
	const airVolume2 = totalResistance > 0 ? roundTo5((props.airVolume || 0) * (airResistance1 / totalResistance)) : 0;
...
console.log('Редактор технических чертежей с неразрывными соединениями полностью загружен! Исправленная версия.');